...
SECRET_KEY = os.environ.get('SOCIAL_SECRET')
...
MIDDLEWARE = [
    'accounts.social_account_middleware.SocialAccountMiddleware',
...
CLEARBIT_SECRET_KEY = os.environ.get('CLEARBIT_SECRET_KEY')
